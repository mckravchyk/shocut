 ...
 *
 * Limitations:
 * - This does not consider custom layouts such as using Dvorak instead of QWERTY for Latin-mode on
 * a non-Latin layout. In that case the shortcut would be mapped per QWERTY while the user uses
 ...
 * distinguish them from custom Latin layouts without further feature detection. KeyQ will not work
 * for those.
 *
